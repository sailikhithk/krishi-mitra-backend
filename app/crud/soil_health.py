...
async def create_soil_health(session: AsyncSession, data: SoilHealthCreate) -> SoilHealthResponse:
...
async def get_soil_health(session: AsyncSession, soil_health_id: int) -> SoilHealthResponse:
