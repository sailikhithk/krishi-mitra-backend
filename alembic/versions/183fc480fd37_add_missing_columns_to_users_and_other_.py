...
def upgrade():
    ...
    op.execute("CREATE TYPE producecategory AS ENUM ('daily', 'weekly_monthly', 'dry_spices_nuts', 'grains')")
    op.add_column('produce_listings', sa.Column('category', postgresql.ENUM('daily', 'weekly_monthly', 'dry_spices_nuts', 'grains', name='producecategory'), nullable=True))
