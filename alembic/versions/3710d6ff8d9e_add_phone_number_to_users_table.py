...
def upgrade():
    ...
    produce_category = postgresql.ENUM(
        "daily", "weekly_monthly", "dry_spices_nuts", "grains", name="producecategory"
    )
    ...
    op.add_column(
        "produce_listings", sa.Column("category", produce_category, nullable=True)
    )
    op.add_column(
